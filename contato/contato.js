 document.addEventListener('DOMContentLoaded', function() {
        ...
        function inicializarBotoesCopiar() {
            ...
            botoesCopiar.forEach(botao => {
                // Verifica se é o botão do WhatsApp
                if (botao.getAttribute('data-texto') === '(31) 98765-4321') {
                    botao.addEventListener('click', function() {
                        // Abre o WhatsApp em vez de copiar
                        window.open('https://wa.me/5531987654321', '_blank');
                    });
                } else {
                    botao.addEventListener('click', function() {
